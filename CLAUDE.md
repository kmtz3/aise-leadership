...
| `<PLUGIN_DATA_DIR>/about/workspace.md` | Workspace specifics: Slack channels, internal coordinators. |
| `<PLUGIN_DATA_DIR>/about/tracker-memory.md` | Cross-customer patterns and learnings spanning multiple accounts. |
